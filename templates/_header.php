...
<header id="top-bar" class="navbar navbar-expand-lg navbar-dark bg-dark" role="navigation" aria-label="<?php echo __('Main navigation'); ?>">
  <div class="container-fluid">
    <?php if (sfConfig::get('app_toggleLogo') || sfConfig::get('app_toggleTitle')) { ?>
      <a class="navbar-brand d-flex flex-wrap flex-lg-nowrap align-items-center py-0 me-0" href="<?php echo url_for('https://www.york.ac.uk/'); ?>" title="<?php echo __('Home'); ?>" rel="home">
        <?php if (sfConfig::get('app_toggleLogo')) { ?>
          <?php echo image_tag('/plugins/arBorthwickB5Plugin/images/logo', ['alt' => __('University of York'), 'class' => 'd-inline-block my-2 me-3', 'height' => '50']); ?>
        <?php } ?>
      </a>
...
<?php if (sfConfig::get('app_toggleDescription') && !empty(sfConfig::get('app_siteDescription'))) { ?>
  <div id="site-slogan" class="bg-secondary text-white">
    <div class="container-xl py-1">
      <a href="https://www.york.ac.uk/borthwick/"><?php echo esc_specialchars(sfConfig::get('app_siteDescription')); ?></a>
    </div>
  </div>
